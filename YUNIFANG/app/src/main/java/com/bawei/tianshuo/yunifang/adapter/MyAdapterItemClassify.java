...
public class MyAdapterItemClassify extends RecyclerView.Adapter<MyAdapterItemClassify.MyViewHolder> {

    private ArrayList<ClassItemBean.DataBean> goods;
    ...
    public MyAdapterItemClassify(ArrayList<ClassItemBean.DataBean> goods, Context context) {
        this.goods = goods;
